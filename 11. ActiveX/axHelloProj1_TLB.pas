...
// PASTLWTR : 1.2
// File generated on 2019-05-16 ¿ÀÈÄ 11:58:38 from Type Library described below.

// ************************************************************************  //
// Type Lib: E:\LeeHanSeo\11. ActiveX\axHelloProj1.tlb (1)
// LIBID: {CD679FEB-0566-49A7-9F38-FD046E50FF61}
// LCID: 0
// Helpfile: 
...
const
  ...
  axHelloProj1MajorVersion = 1;
  axHelloProj1MinorVersion = 0;

  LIBID_axHelloProj1: TGUID = '{CD679FEB-0566-49A7-9F38-FD046E50FF61}';

  IID_IaxHello: TGUID = '{5916C965-9565-404C-82AD-5FAE001206B7}';
  DIID_IaxHelloEvents: TGUID = '{F4F38CEF-5604-4F57-AF4A-91347FEF8DF6}';
  CLASS_axHello: TGUID = '{A6D88F31-ED4E-4B74-BEBC-27A792585E45}';
...
// GUID:      {5916C965-9565-404C-82AD-5FAE001206B7}
// *********************************************************************//
  IaxHello = interface(IDispatch)
    ['{5916C965-9565-404C-82AD-5FAE001206B7}']
...
// *********************************************************************//
  IaxHelloEvents = dispinterface
    ['{F4F38CEF-5604-4F57-AF4A-91347FEF8DF6}']
...
// Control Name     : TaxHello
// Help String      : axHello Control
// Default Interface: IaxHello
// Def. Intf. DISP? : No
// Event   Interface: IaxHelloEvents
// TypeFlags        : (34) CanCreate Control
// *********************************************************************//
  TaxHelloOnKeyPress = procedure(ASender: TObject; var Key: Smallint) of object;

  TaxHello = class(TOleControl)
  private
    ...
    FOnKeyPress: TaxHelloOnKeyPress;
    FOnPaint: TNotifyEvent;
    FIntf: IaxHello;
    function  GetControlInterface: IaxHello;
  protected
  ...
  published
    ...
    property OnKeyPress: TaxHelloOnKeyPress read FOnKeyPress write FOnKeyPress;
...
procedure TaxHello.InitControlData;
const
  ...
  CControlData: TControlData2 = (
    ClassID: '{A6D88F31-ED4E-4B74-BEBC-27A792585E45}';
    EventIID: '{F4F38CEF-5604-4F57-AF4A-91347FEF8DF6}';
    EventCount: 8;
...
procedure TaxHello.CreateControl;

  procedure DoCreate;
  begin
    FIntf := IUnknown(OleObject) as IaxHello;
  end;
...
function TaxHello.GetControlInterface: IaxHello;
begin
  CreateControl;
  Result := FIntf;
end;
...
procedure Register;
begin
  RegisterComponents(dtlOcxPage, [TaxHello]);
end;
